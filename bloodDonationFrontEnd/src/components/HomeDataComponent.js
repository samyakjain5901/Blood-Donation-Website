  ...
  return (
    <Container>
      <Row>
        <Col md="6">
          <Card>
            <CardImg top src="/assets/eligible.jpg" alt="eligible" className="d-none d-md-block"/>
            <CardBody>
              ...
              <Link to="/eligible">
                <Button color="info" className="card-btn">
          ...
          <Card>
            <CardBody>
              <CardImg
                ...
                src="/assets/rbc.jpg"
                alt="rbc"
                style={{ marginBottom: "20px" }} className="d-none d-md-block"
              />
      ...
      <Row>
        <Media className="col-12">
          <Media body className="m-auto col-md-8">
      ...
      <Row>
        <Media className="col-12">
          <Media left middle className="m-auto col-md-4 d-none d-md-inline">
